...
which is the one computer-assisted premise of Section~\ref{sec:transverse}. This
...
(\texttt{results/width4\_drift\_exclusion\_summary.json}). This conclusion uses only
