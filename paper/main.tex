...
\newblock GitHub repository, tagged release \texttt{v1.0}, 2026. The release page pins
the exact commit; \texttt{results/artifact\_hashes.json} in that release gives a
