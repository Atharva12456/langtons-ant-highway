...
a rank-audited exhaustive search---using no consequence of the residue identity, and
...
orbit. In particular the active-loop length, its signed area/orientation, and each
of $E$, $V$, $k$, $\beta$ separately fail to be monotone, with explicit failures on
the blank orbit: at step $4$ the active loop drops from length $20$ to $4$; at time
$14$ the active loop is a \emph{counter}clockwise four-cycle; during one mature
period the cycle rank takes every value in $\{1,\dots,5\}$.
\end{proposition}
...
\emph{independent} engine, which uses no consequence of Theorem~\ref{thm:residue} and
applies the exact criterion to \emph{every} positive-growth nonzero-drift leaf, using
Corollary~\ref{cor:growth4} to skip zero growth; odd periods restore no heading. The
node/leaf counts are $40{,}418{,}033/6{,}989{,}418$ at period $34$;
$108{,}995{,}287/18{,}928{,}333$ at $36$; $293{,}763{,}689/51{,}386{,}767$ at $38$;
$791{,}801{,}484/139{,}000{,}900$ at $40$; $2{,}133{,}302{,}151/376{,}781{,}423$ at
$42$; $5{,}748{,}138{,}964/1{,}018{,}293{,}035$ at $44$;
$15{,}483{,}269{,}352/2{,}757{,}152{,}898$ at $46$; and
$41{,}710{,}394{,}384/7{,}446{,}719{,}550$ at $48$, over all $2^{16}$ prefix ranks
with no node cap. The exact criterion was evaluated at every one of those leaves and
returned zero certificates at every period; every rank is covered exactly once.
